...
module.exports = function (grunt) {
  grunt.initConfig({
      ...
      all: {
        options: {
          process: function (src, filepath) {
            ...
            var iBeginModule = src.indexOf("// begin module "),
              iLicenseEnd = 0,
              iBeginModuleStartLine,
              iEndModule,
              licenseComment = "",
              moduleCode = "",
              iRowStart,
            ...
            if (iBeginModule >= 0) {
              ...
              if (iLicenseEnd > 0) {
                ...
                for (
                  iRowStart = 0;
                  iRowStart < iLicenseEnd;
                  iRowStart = iRowEnd + 1
                ) {
                  iRowEnd = src.indexOf("\n", iRowStart);
                  licenseComment +=
                    (iRowStart + 1 !== iRowEnd ? margin : "") +
                    src.substring(iRowStart, iRowEnd + 1);
                }
              ...
              if (iEndModule >= 0) {
                ...
                moduleCode =
                  licenseComment + src.substring(iBeginModule, iEndModule + 1);
              }
            }
    ...
    tslint: {
      ...
      files: {
        src: ["ts/free-jqgrid.d.ts", "ts/tests/*.ts"],
      },
    },
    jscs: {
      all: {
    ...
    uglify: {
      all: {
        files: {
          ...
          "plugins/min/jquery.contextmenu-ui.js": [
            "plugins/jquery.contextmenu-ui.js",
          ],
          "plugins/min/jquery.contextmenu.js": [
            "plugins/jquery.contextmenu.js",
          ],
          "plugins/min/jquery.createcontexmenufromnavigatorbuttons.js": [
            "plugins/jquery.createcontexmenufromnavigatorbuttons.js",
          ],
          "plugins/min/jquery.jqgrid.showhidecolumnmenu.js": [
  ...
  grunt.registerTask("default", [
    ...
    //"newer:jscs:all",
    "newer:cssmin:target",
    "newer:replace:cssmin_jqgrid",
    "newer:replace:cssmin_multiselect",
    "uglify:all",
    "copy",
  ]);
